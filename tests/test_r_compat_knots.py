"""R compatibility tests for pydlnm knot utilities.
...
class TestLogknots:
    ...
    def test_returns_nk_knots(self):
        for nk in (1, 2, 3, 5):
            assert len(pydlnm.logknots(21, nk=nk)) == nk

    def test_knots_within_range(self):
        knots = pydlnm.logknots(21, nk=4)
    ...
    def test_lag_range_tuple(self):
        ...
        k1 = pydlnm.logknots(21, nk=3)
        k2 = pydlnm.logknots([0, 21], nk=3)
...
class TestEqualknots:
    ...
    def test_returns_nk_knots(self):
        ...
        for nk in (1, 2, 3, 5):
            assert len(pydlnm.equalknots(x, nk=nk)) == nk
